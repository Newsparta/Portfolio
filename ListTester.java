 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, Rhett Edwards
 * @version Spring 2024
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		testTwoElementList(A_listIterAddBAfterNewIter_BA, "A_listIterAddBAfterNewIter_BA", LIST_BA, STRING_BA);
		...
		testSingleElementList(A_listIterSetBAfterNextA_B, "A_listIterSetBAfterA_B", LIST_B, STRING_B);
		...
		testThreeElementList(AB_listIterAddCAfterNewIter_CAB, "AB_listIterAddCAfterNewIter_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_listIterAddCAfterNextA_ACB, "AB_listIterAddCAfterNextA_ACB", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_listIterAddCAfterB_ABC, "AB_listIterAddCAfterB_ABC", LIST_ABC, STRING_ABC);
	...
	////////////////////////////////////////////
	// Single Changed To Other Single Builder //
	////////////////////////////////////////////
	...
	////////////////////////////////////////////
	// Double Changed To Other Double Builder //
	////////////////////////////////////////////
	...
	///////////////////////////////////////
	// Triple to Changed Triple Builders //
	///////////////////////////////////////
	...
	/** Scenario: [A,B,C] -> listIteratorRemoveAfterNextC -> [A,B] 
	...
	/** Scenario: [A] -> listIterAddBAfterNewIter -> [B,A] 
	 * @return [B,A] after listIterAddBAfterNewIter
	 */
	private IndexedUnsortedList<Integer> A_listIterAddBAfterNewIter_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_listIterAddBAfterNewIter_BA = () -> A_listIterAddBAfterNewIter_BA();
	...
	/** Scenario: [A,B] -> listIterAddCAfterNewIter -> [C,A,B] 
	 * @return [] after listIterAddCAfterNewIter
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddCAfterNewIter_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_listIterAddCAfterNewIter_CAB = () -> AB_listIterAddCAfterNewIter_CAB();
	...
	/** Scenario: [A,B] -> listIterAddCAfterB -> [A,B,C] 
	 * @return [A,B,C] after listIterAddCAfterB
	 */
	private IndexedUnsortedList<Integer> AB_listIterAddCAfterB_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> AB_listIterAddCAfterB_ABC = () -> AB_listIterAddCAfterB_ABC();
	...
	/** Scenario: [A,B] -> listIterSetCAfterPreviousB -> [A,C] 
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter2", testListIter(scenario.build(), 4, Result.IndexOutOfBounds));
				printTest(scenarioName + "_testListIterHasNext", testIterHasNext(scenario.build().listIterator(), Result.True));
				printTest(scenarioName + "_testListIterNext", testIterNext(scenario.build().listIterator(), contents[0], Result.MatchingValue));
				printTest(scenarioName + "_testListIterNextIndex", testListIterNextIndex(scenario.build().listIterator(), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIterHasPrevious", testListIterHasPrevious(scenario.build().listIterator(), Result.False));
